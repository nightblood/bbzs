...
import com.zlf.bbzs.util.Constants;
import com.zlf.bbzs.util.SizeUtils;
...
public class ClockViewByPath extends View {
    ...
    public ClockViewByPath(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        mDigitalTimeTextSize = a.getDimensionPixelSize(R.styleable.ClockView_timeTextSize, SizeUtils.dp2px(DEFAULT_DIGITAL_TIME_TEXT_SIZE));
        ...
        mClockPointRadius = a.getDimensionPixelSize(R.styleable.ClockView_pointRadius,
                SizeUtils.dp2px(DEFAULT_CLOCK_POINT_RADIUS));
        ...
        mClockScaleLineWidth = a.getDimensionPixelSize(R.styleable.ClockView_timeScaleWidth,
                SizeUtils.dp2px(DEFAULT_CLOCK_SCALE_LINE_WIDTH));
        mClockScaleLineHeight = a.getDimensionPixelSize(R.styleable.ClockView_timeScaleHeight,
                SizeUtils.dp2px(DEFAULT_CLOCK_SCALE_LINE_HEIGHT));
        ...
        mClockScaleLineColor = a.getDimensionPixelSize(R.styleable.ClockView_timeScaleColor,
                SizeUtils.dp2px(DEFAULT_CLOCK_SCALE_LINE_COLOR));
        a.recycle();
        init();
    }
    ...
    private void init() {
        ...
        mAdjustClockScaleLineStartX = SizeUtils.dp2px(ADJUST_CLOCK_SCALE_LINE_START_X);
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (widthSpecMode != MeasureSpec.EXACTLY) {
            widthMeasureSpec = MeasureSpec.makeMeasureSpec(
                    SizeUtils.dp2px(DEFAULT_CLOCK_VIEW_WIDTH), MeasureSpec.EXACTLY);
        }
